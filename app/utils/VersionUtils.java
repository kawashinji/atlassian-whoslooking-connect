...
{
    private static String ATLASSIAN_DEPLOYMENT_VERSIONS = Play.application().configuration()
                                                              .getString("atlassian.deployment.versions");
    ...
    static
    {
        ...
        if (versionJson == null)
        {
            throw new IllegalStateException("Failed to extract version from version string: "
                                            + ATLASSIAN_DEPLOYMENT_VERSIONS);       
        }
